	...
	return (
		<svg width="569" height="427" viewBox="0 0 569 427" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
			...
			<path
				...
				fill={mounted && theme === 'light' ? 'black' : 'white'}/>
			...
			<text transform="translate(359.057 109.388) rotate(-28)" fill={mounted && theme === 'light' ? 'white' : 'black'} xmlSpace="preserve"
				      style={{whiteSpace: 'pre'}} fontFamily="Clash Display" fontSize="11.7634" fontWeight="600"
				      letterSpacing="0em">
				<tspan x="0" y="12.9136">Finance</tspan>
			</text>
			<text transform="translate(367.647 125.545) rotate(-28)" fill={mounted && theme === 'light' ? 'white' : 'black'} xmlSpace="preserve"
			...
			<circle cx="109.141" cy="262.996" r="15.3578" transform="rotate(-28 109.141 262.996)" stroke="#FF5555"
				        strokeWidth="0.653521"/>
			<text transform="translate(123.631 234.566) rotate(-28)" fill={mounted && theme === 'light' ? 'white' : 'black'} xmlSpace="preserve"
				      style={{whiteSpace: 'pre'}} fontFamily="Clash Display" fontSize="11.7634" fontWeight="600"
				      letterSpacing="0em">
				<tspan x="0" y="12.9136">Achievements</tspan>
			</text>
			<text transform="translate(132.222 250.723) rotate(-28)" fill={mounted && theme === 'light' ? 'white' : 'black'} xmlSpace="preserve"
				      style={{whiteSpace: 'pre'}} fontFamily="Clash Display" fontSize="11.7634" fontWeight="500"
				      letterSpacing="0em">
				<tspan x="0" y="12.9136">Best Finance App On Playstore</tspan>
			</text>
			<line x1="308.912" y1="136.976" x2="307.498" y2="177.47" stroke={mounted && theme === 'light' ? 'white' : 'black'} strokeWidth="0.653522"/>
			...
			<text transform="translate(0 263.263) rotate(-28)" fill={mounted && theme === 'light' ? 'black' : 'white'} xmlSpace="preserve"
