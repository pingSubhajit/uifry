		...
		<GridContainer className={className}>
			<div className="mt-20 md:col-span-7 flex flex-col gap-6 relative">
				...
				<h1 className="text-[4rem] font-bold leading-[4rem] text-balance relative">
					<Image src={redYellowBlurredUnderlay} alt="Red blurred underlay" className="scale-[0.85] absolute -bottom-72 pointer-events-none"/>
			...
			<div className="col-span-5 flex relative pointer-events-none">
				...
				<Image src={redBlurredUnderlay} alt="Red blurred underlay" className="absolute scale-125 -bottom-16 left-28"/>
